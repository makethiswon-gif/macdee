...
/* ── HERO 인트로 — 흩어진 업체 카드 (데스크톱) ──
   서브 문구는 "여러 업체를 로펌이 직접 관리하는 비용"을 하나씩 짚는다. */

export const INTRO_CARDS = [
    { name: "파워링크 광고대행사", sub: "별도 계약" },
    { name: "Google Ads 운영사", sub: "별도 담당자" },
    { name: "블로그 대행사", sub: "별도 보고서" },
    { name: "홈페이지 제작사", sub: "서로 다른 성과 기준" },
    { name: "SEO 업체", sub: "또 다른 연락 창구" },
];

// 모바일은 카드 대신 키워드 다섯 개만 합쳐진다(화면이 좁다).
export const INTRO_KEYWORDS_MOBILE = ["광고", "검색", "콘텐츠", "홈페이지", "데이터"];
