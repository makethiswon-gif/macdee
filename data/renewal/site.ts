...
export const HERO_RESULT =
    "의뢰인이 우리 로펌을 찾고, 믿고, 상담하도록 — 광고·검색·콘텐츠·홈페이지를 하나의 전략으로 연결합니다.";
...
export const JOURNEY: JourneyStep[] = [
    {
        no: "01",
        title: "발견됩니다.",
        desc: "네이버·구글·AI 검색에서 법률 문제를 찾는 순간, 우리 로펌이 보이게 만듭니다.",
        labels: ["광고", "SEO", "GEO"],
    },
    {
        no: "02",
        title: "선택할 이유를 만듭니다.",
        desc: "홈페이지와 콘텐츠로, 찾아온 사람이 왜 이 로펌이어야 하는지 스스로 납득하게 합니다.",
        labels: ["콘텐츠", "홈페이지"],
    },
    {
        no: "03",
        title: "상담과 사건으로 연결합니다.",
        desc: "전화·카카오·폼 유입이 어느 채널에서 왔는지 확인하고, 실제 상담이 생기는 곳에 예산을 집중합니다.",
        labels: ["상담 경로", "데이터 분석"],
    },
];
