...
const fallbackAngles = [
    {
        topic: "사실관계의 시간 순서가 결론을 바꾸는 지점",
        angle: "같은 사실이라도 어느 일이 먼저였는지에 따라 법적 평가가 달라지는 경계를 설명합니다.",
        title: "일의 순서가 결론을 가르는 경우",
        reason: "자기 사안의 위치를 알고 싶은 검색 수요",
    },
    {
    ...
    {
        topic: "비슷해 보이지만 결론이 다른 두 상황",
        angle: "독자가 자기 일로 착각하기 쉬운 옆 사례와 나란히 놓고, 어떤 사실이 결론을 갈랐는지를 설명합니다.",
        title: "같은 상황인데 결론이 갈리는 기준",
        reason: "자기 사안에 대입해 보려는 검색 수요",
    },
    {
