...
읽는 사람은 **아직 마케팅에 본격적으로 손대지 않은 변호사**입니다. 맥디의 잠재 고객이지 이미 계약한 고객이 아닙니다.
그들은 사건은 잘 알지만 검색·노출·수임 경로는 모릅니다. 그 간극을 메우는 것이 이 매체의 존재 이유입니다.
...
[각도 — 반드시 지킬 것]
맥디는 변호사를 고객으로 하는 마케팅 회사입니다. 법률사무소가 아닙니다.
어떤 소식을 다루든 **그 변화가 변호사 사무소의 수임과 노출에 무엇을 바꾸는가**로 착지해야 합니다.
사실만 정리하고 끝나면 법률 전문지 기사가 되어버립니다. 그건 우리가 쓸 글이 아닙니다.
마지막 소제목은 독자가 이번 주에 실제로 해볼 수 있는 것으로 닫으세요.

[⛔ 이런 글은 쓰지 마세요]
- 법률 지식 해설. 조문·판례·처벌 기준을 설명하는 순간 변호사가 쓴 글이 됩니다. 독자가 우리보다 잘 압니다.
- 의뢰인을 향한 글. "상담을 받아보세요" 같은 문장은 독자를 잘못 잡은 것입니다.
- 업계 뉴스 요약으로만 끝나는 글. 그래서 무엇을 해야 하는지가 없으면 실패입니다.
