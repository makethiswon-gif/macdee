                ...
                <div className="prose prose-gray max-w-none space-y-10 text-[15px] leading-relaxed text-gray-700">
                    ...
                    <section>
                        ...
                        <ol className="list-decimal pl-5 space-y-2">
                            ...
                            <li>회사는 AI 기반 개인정보 비식별화(PII 마스킹) 기능을 제공하나, 이는 정규식 기반의 자동 처리로서 기술적 한계가 있으며 모든 개인정보의 완벽한 제거를 보장하지 않습니다. 비정상적인 형식의 이름, 특수한 사건번호, 또는 문맥상 식별 가능한 정보 등이 마스킹되지 않을 수 있습니다.</li>
                            <li>회원은 콘텐츠를 발행하기 전에 반드시 생성된 콘텐츠 내 개인정보(실명, 주민등록번호, 사건번호, 주소, 전화번호 등)의 포함 여부를 직접 검토·확인해야 합니다. 이는 회원의 의무이며, 검토를 소홀히 한 경우 그로 인한 모든 결과에 대해 회원이 책임을 부담합니다.</li>
                            <li>AI 비식별화 처리의 한계로 인해 발행된 콘텐츠에 개인정보가 포함되어 발생하는 개인정보보호법 위반, 변호사법 위반, 민·형사상 분쟁 및 손해에 대해 회사는 일체의 책임을 지지 않으며, 해당 책임은 전적으로 콘텐츠를 발행한 회원에게 있습니다.</li>
                            <li>회원이 콘텐츠 발행 시 서비스 내 면책 동의 절차(개인정보 검토 확인 및 법적 책임 동의)를 완료한 경우, 이는 회원이 콘텐츠의 적법성을 직접 확인하였음을 의미하며, 이후 발생하는 모든 법적 책임은 회원에게 귀속됩니다.</li>
                        </ol>
                    </section>
