...
0. 첫 줄은 제목입니다. 제목에는 절대 ##, ** 등 마크다운 기호를 넣지 마세요. 순수 텍스트 제목만.

1. 소제목은 반드시 ## 으로 시작. 글 전체에 4~6개 사용.
   ## 사건의 시작 - 첫 상담
...
4. 전체 글 구조 예시 (이 형식을 반드시 따르세요):

이 사건은 제가 직접 맡아 처리한 사건입니다.
의뢰인은 **결혼 8년차** 기혼 여성이었습니다.

## 사건의 시작 - 첫 상담

첫 상담에서 의뢰인이 가져온 자료를 검토했습니다.
남편의 부정행위 증거가 상당히 구체적이었습니다.

## 핵심 쟁점

이 사건의 가장 큰 쟁점은 **상대방의 고의성 입증**이었습니다.
상대방은 남편이 기혼인 사실을 몰랐다고 주장했지만, SNS 증거가 결정적이었습니다.

## 변호 전략

저는 SNS 기록과 메시지를 중심으로 증거를 정리했습니다.

## 판결 결과

최종 **위자료 3,000만원**이 인용되었습니다.
이 판결은 상간 사건에서 SNS 증거의 중요성을 보여주는 사례입니다.
