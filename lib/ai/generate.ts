...
const BLOG_STYLES: Record<string, string> = {
    novel: `[스타일: 소설형]
변호사 본인이 이 사건을 맡아 승소한 경험을 이야기처럼 풀어쓰세요.
"그 날, 전화벨이 울렸다."처럼 장면 묘사로 시작.
사건의 시작부터 승소까지, 반전과 긴장감이 있는 법정 드라마처럼.`,

    essay: `[스타일: 에세이]
변호사가 이 사건을 직접 처리하면서 느낀 생각과 소감.
"이 사건은 내가 맡은 사건 중에서도 유독 기억에 남는다."
본인의 법률 전문성과 경험이 자연스럽게 드러나는 글.`,

    column: `[스타일: 칼럼]
변호사 본인이 이런 유형의 사건을 다수 처리한 전문가로서 분석.
"이런 사건을 10년 넘게 다뤄온 입장에서 말하자면" 같은 톤.
본인의 승소 사례를 근거로 실무적 조언을 전달.`,

    review: `[스타일: 후기]
변호사가 직접 처리한 사건의 후기를 담담하게 서술.
"처음 상담 때 의뢰인의 상황은 녹록지 않았다."
어떻게 접근했고, 어떤 전략을 세웠고, 결국 승소했는지.`,
};
...
변호사가 직접 이 사건을 승소(또는 유리하게 해결)시킨 경험담으로 작성하세요.
...
[서식 규칙]
- 마크다운 문법 절대 사용 금지. #, ##, **, *, - 등 일체 금지.
- 네이버 블로그에 바로 복사-붙여넣기 할 수 있는 순수 텍스트만 출력.
- 소제목은 별도 줄에 작성하고 앞뒤에 반드시 빈 줄 2개씩 넣어 구분.
- 문단과 문단 사이에 반드시 빈 줄을 넣으세요.
- 한 문단은 3~5문장. 너무 길면 읽기 힘듬.
- 형식 예시:
