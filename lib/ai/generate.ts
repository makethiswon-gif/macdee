...
- 첫 줄에 사람들이 "더 보기"를 클릭하게 만드는 강렬한 훅을 쓰세요.
- 예: "남편의 불륜 상대에게 위자료를 받을 수 있을까? 결론부터 말하면, 받았습니다."
- 사건의 핵심을 3~5줄로 요약하되, 궁금증을 유발하세요.
- 마지막에 "자세한 사례가 궁금하다면 프로필 링크를 확인하세요" 같은 CTA를 넣으세요.
- 이모지는 ⚖️📌✅ 정도만 절제해서 사용.
- 전체 250~400자 이내.

[hashtags 규칙]
- 사건 유형, 법률 키워드, 지역 등 핵심 키워드로 해시태그 10~15개 생성.
- 예: ["이혼위자료", "불륜소송", "위자료청구", "이혼전문변호사", "가사소송", "법률상담", "승소사례", "변호사추천"]
- 해시태그에 # 기호는 넣지 마세요 (프론트에서 붙입니다).
- 대중적 키워드(법률상담, 변호사)와 구체적 키워드(음주운전무죄, 이혼재산분할)를 섞으세요.`;
