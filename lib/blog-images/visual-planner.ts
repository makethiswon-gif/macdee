...
표지는 주제의 구체적 질문, 설명은 비교/과정/준비사항에 집중해 중복을 줄인다. info/illustration을 생략하지 않는다 — 원고의 절차·기한·서류·조건·비교에서 반드시 정리할 구조를 찾아 4장을 모두 만든다. 구조가 약하면 checklist(상담 전 확인할 것)로라도 원문 근거와 함께 구성한다.
