...
(async () => {
    for (const [phone, href] of [
        ...
        ["변호사직통 010-0000-0000", "tel:01000000000"],
        ["변호사 직통: 010-0000-0000", "tel:01000000000"],
        ["직통 010-0000-0000", "tel:01000000000"],
        ["상담전화: 02-000-0000", "tel:020000000"],
    ...
    for (const phone of [undefined, null, "", ", 02-000-0000", "bad, 02-000-0000", "02-000-0000 / 070-0000-0000",
        "02-000-0000;ext=123", "변호사직통 javascript:alert(1)", "변호사직통 010-0000-0000 / 02-000-0000", "javascript:alert(1)", '020000000\" onclick=\"bad', "123", "1234567890123456"])
